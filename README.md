...
设置IP网段,例如当前IP为100.84.102.15,你的100.107开头的网段上传速度较快,就可以将NETWORK_SEGMENT变量参数设置为    456EF7:100.107.*.*  
(456EF7表示mac后6位，参考DEVICENAME变量,*代表1-225内所有数字，可以设置大于或者小于,例如你想将IP段设置为100.107.大于100.小于80===>100.107.*>100.*<80，格式*+大于或小于+数字（1-255）)

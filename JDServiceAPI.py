...
def getListAllUserDevices():
    ...
    res = requests.post(url,params=GlobalVariable.service_pram,headers=GlobalVariable.service_headers,data=body).json()
    ...
    for resultList in resultLists:
        ...
        # print("设备昵称:",device_name)
        # print("设备MAC:",device_id)
        # print("设备feed_id:",feed_id)
